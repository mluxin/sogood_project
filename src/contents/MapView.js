...
/* homeButton.icon = new am4core.Sprite();ƒ
...
chart.backgroundSeries.mapPolygons.template.polygon.fill = am4core.color("#E2D19D");
...
template.fill = am4core.color("#FEF9EA");
template.stroke = am4core.color("#FEF9EA");
